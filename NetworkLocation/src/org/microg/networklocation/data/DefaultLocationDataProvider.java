...
public abstract class DefaultLocationDataProvider implements LocationDataProvider {
	...
	public Location calculateLocation(final Collection<Location> values, final int minAccuracy) {
		...
		final Location loc = new Location(getIdentifier());
